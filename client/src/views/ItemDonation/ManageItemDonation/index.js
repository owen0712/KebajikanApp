...
const ManageItemDonation = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            {isLoading?<Loading/>:<>
            <BackSection onBackButtonClick={handleRedirectBack} title={isEdit?"Edit Item Donation":"View Item Donation"}/>
            ...
            <div id="donation-right-content">
                <form id="donation_form" onSubmit={event=>handleSubmit(event)}>
                    ...
                    <div className="item-list-board">
                        <p>ITEM LIST</p>
                        {isEdit?<div className="add-item-section">
                            ...
                            <table>
                                {items.map((item,index)=>{
                                    return <tr key={index}>
                                        ...
                                        <td>{item.quantity}</td>
                                        {isEdit?<td><CloseIcon onClick={()=>handleRemoveItemOnClick(index)}/></td>:""}
                                    </tr>
                                })}
                            </table>
                        </div>
                    </div>
                    {isEdit?<div id="tnc-section">
