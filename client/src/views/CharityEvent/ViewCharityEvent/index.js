        ...
        <React.Fragment>
            ...
            <div id="carousel">
                ...
                <span>
                    ...
                    <button onClick={events[0].status=="In Progress"?()=>handleClick("donate",events[0].id):()=>handleClick("apply_help",events[0].id)} className={events[0].status=="In Progress"?"donate-button":"preregistration-button"}>{events[0].status=="In Progress"?"Donate":"Apply For Help"}</button>
                </span>
                <ArrowRightIcon/>
            </div>
