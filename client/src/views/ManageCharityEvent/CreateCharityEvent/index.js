...
const CreateCharityEvent = (props) => {
  ...
  return (
    <React.Fragment>
      <BackSection
        onBackButtonClick={
          props.isAdmin ? handleRedirectBackAdmin : handleRedirectBackUser
        }
        ...
        <div id="create-form-upper-part">
          <div id="charity-form-left-content">
            ...
            <span className="long-input">
              ...
              <textarea
                name="purpose"
                onChange={(event) => handlePurposeOnChange(event)}
              />
            </span>
            <span className="long-input">
          ...
          <div id="charity-form-right-content">
            <span className="short-input">
              ...
              <input
                type="text"
                name="location"
                onChange={(event) => handleLocationOnChange(event)}
              />
            </span>
            <span className="short-input">
            ...
            <span className="short-input">
              ...
              <input
                type="date"
                name="preregistration_start_date"
                onChange={(event) =>
            ...
            <span className="short-input">
              ...
              <input
                ...
                onChange={(event) => handleDonationStartDateOnChange(event)}
              />
            </span>
            <span className="short-input">
              ...
              <input
                ...
                onChange={(event) => handleDonationEndDateOnChange(event)}
              />
            </span>
            <span className="short-input">
              ...
              <input
                ref={fileTextDisplay}
                onClick={handleTextInputOnClick}
                type="text"
                defaultValue="No file is chosen"
              />
            </span>
            <p id="file-upload-reminder">
              * Please upload your charity event proposal together with
              supporting documents in zip files
            </p>
          </div>
        </div>
