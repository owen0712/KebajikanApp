...
const ProfileSideNavigation = (props) =>{
    return(
        <div id="profile-side-navigation">
            <nav>
                <ul id="first-profile-nav-item"><Link to='/' className={props.activeIndex===0?"profile-nav-item-active":"profile-nav-item"}>PROFILE</Link></ul>
                <ul><Link to='/' className={props.activeIndex===1?"profile-nav-item-active":"profile-nav-item"}>PASSWORD</Link></ul>
                <ul><Link to='/application_history/view' className={props.activeIndex===2?"profile-nav-item-active":"profile-nav-item"}>APPLICATION HISTORY</Link></ul>
